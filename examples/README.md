...
Демо-приложение показывает SVG-заглушки из локальной папки `assets` и метаданные из пакета `@russian-flags/samara-oblast`.
...
- отображение SVG из `assets/<slug>/index.svg`;
- отображение списка городов;
- открытие заглушки флага в модальном окне.
